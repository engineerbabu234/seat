$(document).ready(function(){
		...
		columns: [
			...
			{ data: 'id', name: 'id' , 
				...
				return '<div class="btns">'+
					...
					'<a href="'+base_url+'/admin/driver/show/'+column.id+'"><button class="eye"><i class="fa fa-eye"></i></button></a>'+
					'</div>' ;
				}
			}
		]
	...
	$('body').on('click','.active-status-change', function() {
		...
		path='admin/driver/active_status_change/';
	...
	$('body').on('click','.approve-status-change', function() {
		...
		path='admin/driver/approve_status_change/';
