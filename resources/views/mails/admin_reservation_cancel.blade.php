                                                 ...
                                                 <tr>
                                                    <td valign="top" style="padding: 0px 48px 0; padding-left: 20px; padding-right: 20px;">
                                                       <div id="body_content_inner" style="color: #3d3d3d; text-align: left; font-size: 14px; line-height: 25px; font-family: &quot;Lucida Sans Unicode&quot;, &quot;Lucida Grande&quot;, sans-serif; font-weight: 400;">
                                                          ...
                                                          <p style="margin: 0; padding: 15px 0">Welcome and thank you for being a part of the weBhook Family and sorry because for reservationid : {{$data['data']->reservation_id}}  made for date {{ date('d-m-Y',strtotime($data['data']->reserve_date)) }}  was cancelled as the admin had to block the seat. Please reserve another seat</p>
