		...
		<nav>
			...
			<div class="navlink">
				<ul>
					...
					<li>
						<a class="@if((substr(strrchr(url()->current(),"/"),1)=='user')){{'active'}}@endif" href="{{route('admin/user/index')}}"><i class="fas fa-users"></i> <span>Users</span></a>
					</li>
					<li>
						<a class="@if((substr(strrchr(url()->current(),"/"),1)=='add_building')){{'active'}}@endif" href="{{route('admin/building/add_building')}}"><i class="fas fa-building"></i> <span>Add Bulding</span></a>
					</li>

					<li>
						<a class="@if((substr(strrchr(url()->current(),"/"),1)=='add_office')){{'active'}}@endif" href="{{route('admin/office/add_office')}}"><i class="fas fa-plus"></i> <span>Add Office</span></a>
					</li>
					<li>
					...
					<li>
						<a class="@if((substr(strrchr(url()->current(),"/"),1)=='reservation_history')){{'active'}}@endif" href="{{route('admin/reservation/reservation_history')}}"><i class="fa fa-list"></i> <span>Reservation History</span></a>
					</li>
					<li>
