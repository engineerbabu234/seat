				...
				<div class="row">
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input type="text" class="form-control" placeholder="Username" name="username"  value="{{$apiconnections->username}}" >
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input type="text" class="form-control" placeholder="Password" name="password" value="{{$apiconnections->password}}">
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input type="text" class="form-control" placeholder="Integrator Key" name="integrator_key" value="{{$apiconnections->integrator_key}}" >
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input type="text" class="form-control" placeholder="Host" name="host" value="{{$apiconnections->host}}"  >
