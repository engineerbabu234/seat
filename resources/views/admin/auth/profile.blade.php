                            ...
                            <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    <div class="profile-details">
                                        ...
                                        <div class="body">
                                            <form method="POST" id="reminder_configration" action="{{ route('update_reminder_configration') }}"   >
                                                @csrf
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <div class="form-group">
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="checkbox"  @if($data['user']->reminder == 1) {{'checked'}} @endif name="reminder" id="reminder">
                                                                <label class="form-check-label reminder_notification" for="reminder">
                                                                    Reminder For Notification Subscribe
                                                                </label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12">
                                                        <div class="form-group">
                                                            <h6 class="sub-title"><span class="iconWrap iconSize_32" title="Reminder Notification For Whatsapp Opt in" data-content="Reminder Notification Whatsapp Opt in" data-trigger="hover" data-placement="left"><img src="{{asset('admin_assets')}}/images/expire_after.png" class="icon bl-icon" width="30" ></span> <span class="text-danger">*</span></h6>
                                                            <div class="row">
                                                                <div class="col-sm-12">
                                                                    <select class="form-control" name="repeat_value" id="repeat_value">
                                                                        <option @if($data['user']->repeat_value == 'day') {{'selected'}} @endif value="day">Daily</option>
                                                                        <option  @if($data['user']->repeat_value == 'month') {{'selected'}} @endif value="month">Monthly</option>
                                                                        <option @if($data['user']->repeat_value == 'week') {{'selected'}} @endif value="week">Weekly</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        </div>
