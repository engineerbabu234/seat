...
@section('content')
	<div class="main-body">
		<div class="inner-body">
			<h2 style="font-size: 23px;">Create Vehicle Type</h2>
			<div class="add-driver clear-col">
				...
				@endif
				<form method="POST" enctype="multipart/form-data" action="{{ route('admin/vehicle_type/store') }}">
					@csrf
					{{ method_field('PUT') }}
						...
						<div class="row">
							<div class="col-md-6 col-sm-6 col-xs-12">
								<div class="form-group">
									...
									<input type="text" placeholder="Vehicle Type Name" class="form-control" name="vehicle_type_name" value="{{old('vehicle_type_name')}}">
